...
- 已批准设计在 `docs/zh-CN/design.md`，Phase 2 清单在 `docs/zh-CN/plans/phase-02.md`，Phase 3 清单在 `docs/zh-CN/plans/phase-03.md`。当前已实现配置、存储与状态机，尚未接入邮件与 Agent，命令行也尚未使用它们；不把规划的邮箱/Agent 接入写成已支持。
